...
const assistanceVisuals = [
  {
    ...
    text: "Monitoraggio live delle richieste con priorita e tempi di intervento tracciati in modo chiaro.",
...
export default function AssistenzaPage() {
  return (
    <SiteFrame activePath="/assistenza">
      <PremiumRouteShell
        eyebrow="Assistenza Premium"
        title="Supporto tecnico piu chiaro, veloce e orientato all'impatto"
        description="Abbiamo mantenuto lo stesso significato operativo ma con immagini diverse e piu leggibili, per comunicare immediatamente priorita, tempi e risultato atteso."
        chips={["SLA visibili", "Escalation chiara", "Supporto remoto", "Continuita operativa"]}
      >
        <InternalPageTemplate
          ...
          imageAlt="Assistenza tecnica con monitoraggio in tempo reale"
          mediaSecondaryImage="/site/premium-final/04-business-continuity.jpg"
          mediaSecondaryAlt="Continuita e protezione operativa"
